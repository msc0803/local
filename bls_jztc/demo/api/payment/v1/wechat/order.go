...
type WxPayUnifiedOrderReq struct {
	g.Meta   `path:"/unified-order" method:"post" tags:"微信支付" summary:"微信支付统一下单" security:"Bearer" description:"微信支付统一下单接口，用于创建微信支付订单"`
...
type WxPayOrderQueryReq struct {
	g.Meta  `path:"/query" method:"get" tags:"微信支付" summary:"微信支付订单查询" security:"Bearer" description:"微信支付订单查询接口，查询订单支付状态"`
	OrderNo string `v:"required#订单号不能为空" json:"orderNo" dc:"订单号"`
}
